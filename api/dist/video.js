...
// CONCATENATED MODULE: ./video/api/video.model.ts

const VideoModel = new core_model["a" /* Model */]({
    enable: input => ({ enable: !!input }),
});

// CONCATENATED MODULE: ./video/api/env.ts
const ROUTE_BASE = '/video';
const DATATABLE = 'video';

// CONCATENATED MODULE: ./video/api/add.api.ts
...
// CONCATENATED MODULE: ./video/api/delete.api.ts
...
// CONCATENATED MODULE: ./video/api/get.api.ts
...
// CONCATENATED MODULE: ./video/api/update.api.ts
...
// CONCATENATED MODULE: ./video/api/index.ts





// CONCATENATED MODULE: ./video/main.ts




process.env.TZ = 'UTC';
new service["i" /* Service */](new db["c" /* DBMiddleware */](), new session["a" /* CustomSessionMiddleware */](), new get_api_GetAPI(), new add_api_AddAPI(), new update_api_UpdateAPI(), new delete_api_DeleteAPI);
