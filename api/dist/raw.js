...
// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/core/db/index.ts + 19 modules
var core_db = __webpack_require__(3);
...
// CONCATENATED MODULE: ./raw/api/env.ts
const ROUTE_BASE = '/raw';
const DATATABLE = 'raw';

// CONCATENATED MODULE: ./raw/api/add.api.ts
...
class add_api_AddAPI extends service["h" /* RouteMiddleware */] {
    async add(ctx, next) {
        ...
        const db = ctx.db;
        const lom = new core_db["d" /* LargeObjectManager */]({ pg: db });
        await db.query('BEGIN');
        let oid;
        try {
            oid = await lom.createAsync();
            const lo = await lom.openAsync(oid, core_db["d" /* LargeObjectManager */].WRITE);
...
__decorate([
    Object(service["g" /* Put */])(ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Author, role["a" /* Role */].Publisher, role["a" /* Role */].Ads, role["a" /* Role */].Administrator, role["a" /* Role */].Su),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [service["b" /* Context */], Function]),
    __metadata("design:returntype", Promise)
], add_api_AddAPI.prototype, "add", null);

// CONCATENATED MODULE: ./raw/api/delete.api.ts
...
class delete_api_DeleteAPI extends service["h" /* RouteMiddleware */] {
    async delete(ctx, next) {
        ...
        ctx.debug(`=== Large object [ DELETE ${delete_api_ROUTE_PATH} ] %s ===`, oid);
        const db = ctx.db;
        const lom = new core_db["d" /* LargeObjectManager */]({ pg: db });
        await db.query('BEGIN');
        try {
            ...
            await db.query('ROLLBACK');
            if (error.code === core_db["b" /* DBError */].UNDEFINED_OBJECT) {
                ctx.set(404);
                return;
            }
            ctx.throw(error);
...
// CONCATENATED MODULE: ./raw/api/index.ts



// CONCATENATED MODULE: ./raw/main.ts




process.env.TZ = 'UTC';
new service["i" /* Service */](new core_db["c" /* DBMiddleware */](), new session["a" /* CustomSessionMiddleware */](), new add_api_AddAPI(), new delete_api_DeleteAPI());
