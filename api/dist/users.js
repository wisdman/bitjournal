...
// CONCATENATED MODULE: /Users/wisdman/Projects/bitjournal/common/role/role.ts
class Role {
...
Role.User = new Role('user', 'Пользователь', null);
Role.Author = new Role('author', 'Автор', null);
Role.Publisher = new Role('publisher', 'Публикатор', null);
Role.Ads = new Role('ads', 'Рекламщик', null);
Role.Administrator = new Role('administrator', 'Администратор', null);
Role.Su = new Role('su', 'Super user', null);

// CONCATENATED MODULE: /Users/wisdman/Projects/bitjournal/common/role/index.ts
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "a", function() { return Role; });
...
var external__crypto_ = __webpack_require__(26);
...
// CONCATENATED MODULE: /Users/wisdman/Projects/bitjournal/common/session/session.middleware.ts


const SESSION_TOKEN_REGEXP = /token\s+([0-9a-f]{128})/;
const ROLES_PG_ARRAY_PATTERN = /^\{([a-z0-9,]+)\}$/;
class session_middleware_CustomSessionMiddleware extends service["j" /* SessionMiddleware */] {
    async init(ctx) {
        const matchId = SESSION_TOKEN_REGEXP.exec(ctx.request.getHeader('Authorization') || '');
        const id = matchId && matchId[1] || '';
        if (!id)
            return {};
        const query = new db["a" /* CustomQuery */](`SELECT
                                     "users".id,
                                     "users".roles,
                                   FROM
                                     "sessions"
        ...
        const result = await query.exec(ctx.db);
        if (result.length !== 1)
            return {};
        return {
            id: id,
...
// CONCATENATED MODULE: /Users/wisdman/Projects/bitjournal/common/session/index.ts
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "a", function() { return session_middleware_CustomSessionMiddleware; });
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "a", function() { return otp_OTP; });
...
__webpack_require__.d(status_namespaceObject, "AddAPI", function() { return add_api_AddAPI; });
__webpack_require__.d(status_namespaceObject, "DeleteAPI", function() { return delete_api_DeleteAPI; });
__webpack_require__.d(status_namespaceObject, "GetAPI", function() { return get_api_GetAPI; });
__webpack_require__.d(status_namespaceObject, "UpdateAPI", function() { return update_api_UpdateAPI; });
var user_namespaceObject = {};
__webpack_require__.d(user_namespaceObject, "AddAPI", function() { return user_add_api_AddAPI; });
__webpack_require__.d(user_namespaceObject, "DeleteAPI", function() { return user_delete_api_DeleteAPI; });
__webpack_require__.d(user_namespaceObject, "GetByIdAPI", function() { return get_id_api_GetByIdAPI; });
__webpack_require__.d(user_namespaceObject, "GetListAPI", function() { return get_list_api_GetListAPI; });
__webpack_require__.d(user_namespaceObject, "PasswordAPI", function() { return password_api_PasswordAPI; });
__webpack_require__.d(user_namespaceObject, "UpdateAPI", function() { return user_update_api_UpdateAPI; });
__webpack_require__.d(user_namespaceObject, "GetMeAPI", function() { return get_api_GetMeAPI; });
__webpack_require__.d(user_namespaceObject, "DeleteOTPAPI", function() { return delete_api_DeleteOTPAPI; });
__webpack_require__.d(user_namespaceObject, "GetOTPAPI", function() { return get_api_GetOTPAPI; });
__webpack_require__.d(user_namespaceObject, "SetOTPAPI", function() { return set_api_SetOTPAPI; });
...
// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/common/session/index.ts + 1 modules
var session = __webpack_require__(59);

// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/common/role/index.ts + 1 modules
var role = __webpack_require__(9);

// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/core/model/index.ts + 1 modules
var core_model = __webpack_require__(60);

// CONCATENATED MODULE: ./users/api/status/status.model.ts

const StatusModel = new core_model["a" /* Model */]({
...
// CONCATENATED MODULE: ./users/api/status/env.ts
const ROUTE_BASE = '/statuses';
const DATATABLE = 'statuses';

// CONCATENATED MODULE: ./users/api/status/add.api.ts
...
class add_api_AddAPI extends service["h" /* RouteMiddleware */] {
    async add(ctx, next) {
...
__decorate([
    Object(service["f" /* Post */])(ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Administrator, role["a" /* Role */].Su),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [service["b" /* Context */], Function]),
    __metadata("design:returntype", Promise)
], add_api_AddAPI.prototype, "add", null);

// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/core/uuid/index.ts + 5 modules
var core_uuid = __webpack_require__(27);

// CONCATENATED MODULE: ./users/api/status/delete.api.ts
var delete_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var delete_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const delete_api_ROUTE_PATH = `${ROUTE_BASE}/:id`;
class delete_api_DeleteAPI extends service["h" /* RouteMiddleware */] {
    async delete(ctx, next) {
        let id;
        try {
            const uuid = new core_uuid["a" /* UUID */](ctx.route.data.id);
            id = String(uuid);
        }
        catch (error) {
        ...
        const query = new db["e" /* Query */](DATATABLE)
            ...
            .where('id = $1', id)
            .returning('id');
        let result = await query.exec(ctx.db);
        if (result.length !== 1) {
            ctx.set(404);
            return;
        }
...
delete_api___decorate([
    Object(service["c" /* Delete */])(delete_api_ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Administrator, role["a" /* Role */].Su),
    delete_api___metadata("design:type", Function),
    delete_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    delete_api___metadata("design:returntype", Promise)
], delete_api_DeleteAPI.prototype, "delete", null);

// CONCATENATED MODULE: ./users/api/status/get.api.ts
var get_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var get_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const get_api_ROUTE_PATH = `${ROUTE_BASE}`;
...
class get_api_GetAPI extends service["h" /* RouteMiddleware */] {
    async get(ctx, next) {
        let query;
        if (ctx.session.roles.checkAny(FULL_ACCES_ROLES) === true)
            query = new db["e" /* Query */](DATATABLE)
...
get_api___decorate([
    Object(service["d" /* Get */])(get_api_ROUTE_PATH),
    get_api___metadata("design:type", Function),
    get_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    get_api___metadata("design:returntype", Promise)
], get_api_GetAPI.prototype, "get", null);

// CONCATENATED MODULE: ./users/api/status/update.api.ts
var update_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var update_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const update_api_ROUTE_PATH = `${ROUTE_BASE}/:id`;
class update_api_UpdateAPI extends service["h" /* RouteMiddleware */] {
...
update_api___decorate([
    Object(service["f" /* Post */])(update_api_ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Administrator, role["a" /* Role */].Su),
    update_api___metadata("design:type", Function),
    update_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    update_api___metadata("design:returntype", Promise)
], update_api_UpdateAPI.prototype, "update", null);

// CONCATENATED MODULE: ./users/api/status/index.ts





// CONCATENATED MODULE: ./users/api/user/user.model.ts
...
const UserModel = new core_model["a" /* Model */]({
    enable: input => ({ enable: !!input }),
    roles: input => {
        const result = role["a" /* Role */].getArray(input);
        if (result.length === 0)
    ...
    statuses: input => {
        const result = new Array()
            .concat(input)
            .map(item => new core_uuid["a" /* UUID */](item))
...
// CONCATENATED MODULE: ./users/api/user/env.ts
const env_ROUTE_BASE = '/users';
const env_DATATABLE = 'users';

// CONCATENATED MODULE: ./users/api/user/add.api.ts
var add_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var add_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const add_api_ROUTE_PATH = `${env_ROUTE_BASE}`;
const add_api_FIELDS = [
    "id",
    "enable",
    "roles",
    "url",
...
class user_add_api_AddAPI extends service["h" /* RouteMiddleware */] {
    async add(ctx, next) {
        const data = await ctx.request.json();
        ...
        const query = new db["e" /* Query */](env_DATATABLE)
            .insert(model.value)
            .returning(add_api_FIELDS);
        const result = await query.exec(ctx.db)
            .catch(error => error);
        if (!Array.isArray(result)) {
            if (result.code === db["b" /* DBError */].UNIQUE_VIOLATION) {
                ctx.set(409);
                return;
            }
            ctx.throw(result);
...
add_api___decorate([
    Object(service["f" /* Post */])(add_api_ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Administrator, role["a" /* Role */].Su),
    add_api___metadata("design:type", Function),
    add_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    add_api___metadata("design:returntype", Promise)
], user_add_api_AddAPI.prototype, "add", null);

// CONCATENATED MODULE: ./users/api/user/delete.api.ts
var user_delete_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var user_delete_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const user_delete_api_ROUTE_PATH = `${env_ROUTE_BASE}/:id`;
class user_delete_api_DeleteAPI extends service["h" /* RouteMiddleware */] {
    async delete(ctx, next) {
        let id;
        try {
            const uuid = new core_uuid["a" /* UUID */](ctx.route.data.id);
...
user_delete_api___decorate([
    Object(service["c" /* Delete */])(user_delete_api_ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Administrator, role["a" /* Role */].Su),
    user_delete_api___metadata("design:type", Function),
    user_delete_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    user_delete_api___metadata("design:returntype", Promise)
], user_delete_api_DeleteAPI.prototype, "delete", null);

// CONCATENATED MODULE: ./users/api/user/get-id.api.ts
var get_id_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var get_id_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const get_id_api_ROUTE_PATH = `${env_ROUTE_BASE}/:id`;
const get_id_api_FULL_ACCES_ROLES = [
    role["a" /* Role */].Administrator,
    role["a" /* Role */].Su
];
const get_id_api_FIELDS_FOR_EVERYONE = [
    "id",
    "url",
    "title",
    "image",
...
const get_id_api_FIELDS_FOR_ADMINS = get_id_api_FIELDS_FOR_EVERYONE.concat([
    "enable",
    "roles",
    "description",
    "email",
...
class get_id_api_GetByIdAPI extends service["h" /* RouteMiddleware */] {
    async get(ctx, next) {
        let id;
        try {
            const uuid = new core_uuid["a" /* UUID */](ctx.route.data.id);
        ...
        let query;
        if (ctx.session.roles.checkAny(get_id_api_FULL_ACCES_ROLES) === true)
            query = new db["e" /* Query */](env_DATATABLE)
                .select(get_id_api_FIELDS_FOR_ADMINS)
                .where('id = $1', id);
        else
            query = new db["e" /* Query */](env_DATATABLE)
                .select(get_id_api_FIELDS_FOR_EVERYONE)
...
get_id_api___decorate([
    Object(service["d" /* Get */])(get_id_api_ROUTE_PATH),
    get_id_api___metadata("design:type", Function),
    get_id_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    get_id_api___metadata("design:returntype", Promise)
], get_id_api_GetByIdAPI.prototype, "get", null);

// CONCATENATED MODULE: ./users/api/user/get-list.api.ts
var get_list_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var get_list_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const get_list_api_ROUTE_PATH = `${env_ROUTE_BASE}`;
const get_list_api_FULL_ACCES_ROLES = [
    role["a" /* Role */].Administrator,
    role["a" /* Role */].Su
];
const get_list_api_FIELDS_FOR_EVERYONE = [
    "id",
    "url",
    "title",
    "image",
...
const get_list_api_FIELDS_FOR_ADMINS = get_list_api_FIELDS_FOR_EVERYONE.concat([
    "enable",
    "roles",
    "email",
    "phone",
]);
class get_list_api_GetListAPI extends service["h" /* RouteMiddleware */] {
    async get(ctx, next) {
        let query;
        if (ctx.session.roles.checkAny(get_list_api_FULL_ACCES_ROLES) === true)
            query = new db["e" /* Query */](env_DATATABLE)
                .select(get_list_api_FIELDS_FOR_ADMINS)
                .order({ 'url': 'DESC' });
        else
            query = new db["e" /* Query */](env_DATATABLE)
                .select(get_list_api_FIELDS_FOR_EVERYONE)
                .where('enable')
                .order({ 'url': 'DESC' });
        const limit = Math.max(~~(new Array().concat(ctx.route.query['limit']).join('')) || 0, 0);
        if (limit > 0)
...
get_list_api___decorate([
    Object(service["d" /* Get */])(get_list_api_ROUTE_PATH),
    get_list_api___metadata("design:type", Function),
    get_list_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    get_list_api___metadata("design:returntype", Promise)
], get_list_api_GetListAPI.prototype, "get", null);

// CONCATENATED MODULE: ./users/api/user/password.api.ts
var password_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var password_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const password_api_ROUTE_PATH = `${env_ROUTE_BASE}/:id`;
class password_api_PasswordAPI extends service["h" /* RouteMiddleware */] {
...
password_api___decorate([
    Object(service["f" /* Post */])(password_api_ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Administrator, role["a" /* Role */].Su),
    password_api___metadata("design:type", Function),
    password_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    password_api___metadata("design:returntype", Promise)
], password_api_PasswordAPI.prototype, "password", null);

// CONCATENATED MODULE: ./users/api/user/update.api.ts
var user_update_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var user_update_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const user_update_api_ROUTE_PATH = `${env_ROUTE_BASE}/:id`;
class user_update_api_UpdateAPI extends service["h" /* RouteMiddleware */] {
    async update(ctx, next) {
        let id;
        try {
            const uuid = new core_uuid["a" /* UUID */](ctx.route.data.id);
...
user_update_api___decorate([
    Object(service["f" /* Post */])(user_update_api_ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Administrator, role["a" /* Role */].Su),
    user_update_api___metadata("design:type", Function),
    user_update_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    user_update_api___metadata("design:returntype", Promise)
], user_update_api_UpdateAPI.prototype, "update", null);

// CONCATENATED MODULE: ./users/api/user/me/get.api.ts
var me_get_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var me_get_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};



const me_get_api_ROUTE_PATH = `${env_ROUTE_BASE}/me`;
const FIELDS_FOR_ME = [
    "id",
    "url",
    "title",
...
class get_api_GetMeAPI extends service["h" /* RouteMiddleware */] {
    async get(ctx, next) {
...
me_get_api___decorate([
    Object(service["d" /* Get */])(me_get_api_ROUTE_PATH),
    me_get_api___metadata("design:type", Function),
    me_get_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    me_get_api___metadata("design:returntype", Promise)
], get_api_GetMeAPI.prototype, "get", null);

// CONCATENATED MODULE: ./users/api/user/me/index.ts


// CONCATENATED MODULE: ./users/api/user/otp/delete.api.ts
var otp_delete_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var otp_delete_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const otp_delete_api_ROUTE_PATH = `${env_ROUTE_BASE}/:id/otp`;
class delete_api_DeleteOTPAPI extends service["h" /* RouteMiddleware */] {
    async delete(ctx, next) {
        let id;
        try {
            const uuid = new core_uuid["a" /* UUID */](ctx.route.data.id);
...
otp_delete_api___decorate([
    Object(service["c" /* Delete */])(otp_delete_api_ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Su),
    otp_delete_api___metadata("design:type", Function),
    otp_delete_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    otp_delete_api___metadata("design:returntype", Promise)
], delete_api_DeleteOTPAPI.prototype, "delete", null);

// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/core/otp/index.ts + 2 modules
var core_otp = __webpack_require__(63);

// CONCATENATED MODULE: ./users/api/user/otp/get.api.ts
var otp_get_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var otp_get_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const otp_get_api_ROUTE_PATH = `${env_ROUTE_BASE}/:id/otp`;
class get_api_GetOTPAPI extends service["h" /* RouteMiddleware */] {
    async get(ctx, next) {
        let id;
        try {
            const uuid = new core_uuid["a" /* UUID */](ctx.route.data.id);
        ...
        const otp = new core_otp["a" /* OTP */]({ secret });
        ctx.set({ secret: otp.base32Secret });
    }
}
otp_get_api___decorate([
    Object(service["d" /* Get */])(otp_get_api_ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Su),
    otp_get_api___metadata("design:type", Function),
    otp_get_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    otp_get_api___metadata("design:returntype", Promise)
], get_api_GetOTPAPI.prototype, "get", null);

// CONCATENATED MODULE: ./users/api/user/otp/set.api.ts
var set_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var set_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const set_api_ROUTE_PATH = `${env_ROUTE_BASE}/:id/otp`;
class set_api_SetOTPAPI extends service["h" /* RouteMiddleware */] {
    async set(ctx, next) {
        let id;
        try {
            const uuid = new core_uuid["a" /* UUID */](ctx.route.data.id);
...
set_api___decorate([
    Object(service["f" /* Post */])(set_api_ROUTE_PATH),
    Object(service["a" /* ACL */])(role["a" /* Role */].Su),
    set_api___metadata("design:type", Function),
    set_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    set_api___metadata("design:returntype", Promise)
], set_api_SetOTPAPI.prototype, "set", null);

// CONCATENATED MODULE: ./users/api/user/otp/index.ts




// CONCATENATED MODULE: ./users/api/user/index.ts
...
// CONCATENATED MODULE: ./users/api/index.ts




// CONCATENATED MODULE: ./users/main.ts




process.env.TZ = 'UTC';
new service["i" /* Service */](new db["c" /* DBMiddleware */](), new session["a" /* CustomSessionMiddleware */](), new status_namespaceObject.GetAPI(), new status_namespaceObject.AddAPI(), new status_namespaceObject.UpdateAPI(), new status_namespaceObject.DeleteAPI(), new user_namespaceObject.GetListAPI(), new user_namespaceObject.GetByIdAPI(), new user_namespaceObject.AddAPI(), new user_namespaceObject.UpdateAPI(), new user_namespaceObject.DeleteAPI(), new user_namespaceObject.PasswordAPI(), new user_namespaceObject.GetOTPAPI(), new user_namespaceObject.SetOTPAPI(), new user_namespaceObject.DeleteOTPAPI());
