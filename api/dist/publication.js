...
// CONCATENATED MODULE: /Users/wisdman/Projects/bitjournal/common/section/section.ts
class Section {
    constructor(id, title, og) {
        this.id = id;
        this.title = title;
        this.og = og;
    }
...
Section.Main = new Section('main', 'Главная', {
...
Section.Newbie = new Section('101', 'Новичкам', {
...
// CONCATENATED MODULE: /Users/wisdman/Projects/bitjournal/common/section/index.ts


// CONCATENATED MODULE: ./publication/api/publication.model.ts




const URL_REGEXP = /^[a-z0-9]([a-z0-9_-]*[a-z0-9])?$/;
const PublicationModel = new core_model["a" /* Model */]({
    enable: input => ({ enable: !!input }),
    ts: input => ({ ts: new timestamp["a" /* Timestamp */](input).iso }),
    url: input => {
...
// CONCATENATED MODULE: ./publication/api/env.ts
const ROUTE_BASE = '/publications';
const DATATABLE = 'publications';

// CONCATENATED MODULE: ./publication/api/add.api.ts
...
class add_api_AddAPI extends service["h" /* RouteMiddleware */] {
    async add(ctx, next) {
        ...
        const model = PublicationModel(data);
...
__decorate([
    ...
    Object(service["a" /* ACL */])(role["a" /* Role */].Author, role["a" /* Role */].Publisher, role["a" /* Role */].Administrator, role["a" /* Role */].Su),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [service["b" /* Context */], Function]),
    __metadata("design:returntype", Promise)
], add_api_AddAPI.prototype, "add", null);

// CONCATENATED MODULE: ./publication/api/delete.api.ts
...
delete_api___decorate([
    ...
    Object(service["a" /* ACL */])(role["a" /* Role */].Publisher, role["a" /* Role */].Administrator, role["a" /* Role */].Su),
...
// CONCATENATED MODULE: ./publication/api/get-id.api.ts
...
const get_id_api_ROUTE_PATH = `${ROUTE_BASE}/:id`;
...
// CONCATENATED MODULE: ./publication/api/get-list.api.ts
...
const get_list_api_ROUTE_PATH = `${ROUTE_BASE}`;
...
// CONCATENATED MODULE: ./publication/api/update.api.ts
...
class update_api_UpdateAPI extends service["h" /* RouteMiddleware */] {
    async update(ctx, next) {
        ...
        if (ctx.session.roles.checkAny(FULL_ACCESS_ROLES) === true)
            ...
            const getAuthorsQuery = new db["e" /* Query */](DATATABLE)
                .select(['authors'])
                .where('id = $1', id);
            let getAuthorsResult = await getAuthorsQuery.exec(ctx.db);
...
// CONCATENATED MODULE: ./publication/api/index.ts
...
// CONCATENATED MODULE: ./publication/main.ts




process.env.TZ = 'UTC';
new service["i" /* Service */](new db["c" /* DBMiddleware */](), new session["a" /* CustomSessionMiddleware */](), new get_list_api_GetListAPI(), new get_id_api_GetByIdAPI(), new add_api_AddAPI(), new update_api_UpdateAPI(), new delete_api_DeleteAPI);
