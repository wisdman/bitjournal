...
// CONCATENATED MODULE: ./auth/api/env.ts
const ROUTE_BASE = '/auth';

// CONCATENATED MODULE: ./auth/api/login.api.ts
...
const ROUTE_PATH = `${ROUTE_BASE}/login`;
class login_api_LoginAPI extends service["h" /* RouteMiddleware */] {
    async login(ctx, next) {
        ...
        const query = new db["e" /* Query */]('users')
            .select(['id', 'totp', 'roles'])
            .where("enable AND email = $1 AND password = encode(digest($2, 'sha512'), 'hex')", body.email, body.password);
        const result = await query.exec(ctx.db);
        if (result.length !== 1) {
            ctx.set(403);
            return;
        ...
        const sessionQuery = new db["e" /* Query */]('sessions')
            .insert({
            owner: String(user.id),
            ip: ctx.session.ip,
        }).returning(['id']);
        const sessionResult = await sessionQuery.exec(ctx.db);
...
], login_api_LoginAPI.prototype, "login", null);

// CONCATENATED MODULE: ./auth/api/logout.api.ts
var logout_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var logout_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};



const logout_api_ROUTE_PATH = `${ROUTE_BASE}/logout`;
class logout_api_LogoutAPI extends service["h" /* RouteMiddleware */] {
    async logout(ctx, next) {
        const user = ctx.session.data.user;
        if (user) {
            const query = new db["e" /* Query */]('sessions').delete()
...
logout_api___decorate([
    Object(service["d" /* Get */])(logout_api_ROUTE_PATH),
    logout_api___metadata("design:type", Function),
    logout_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    logout_api___metadata("design:returntype", Promise)
], logout_api_LogoutAPI.prototype, "logout", null);

// CONCATENATED MODULE: ./auth/api/root.api.ts
var root_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var root_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};


const root_api_ROUTE_PATH = `${ROUTE_BASE}`;
class RootAPI extends service["h" /* RouteMiddleware */] {
    async auth(ctx, next) {
...
root_api___decorate([
    Object(service["d" /* Get */])(root_api_ROUTE_PATH),
    root_api___metadata("design:type", Function),
    root_api___metadata("design:paramtypes", [service["b" /* Context */], Function]),
    root_api___metadata("design:returntype", Promise)
], RootAPI.prototype, "auth", null);

// CONCATENATED MODULE: ./auth/api/index.ts




// CONCATENATED MODULE: ./auth/main.ts




process.env.TZ = 'UTC';
new service["i" /* Service */](new db["c" /* DBMiddleware */](), new session["a" /* CustomSessionMiddleware */](), new RootAPI(), new login_api_LoginAPI(), new logout_api_LogoutAPI());
