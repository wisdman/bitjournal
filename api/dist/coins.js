...
// CONCATENATED MODULE: ./coins/api/env.ts
const ROUTE_BASE = '/coins';
const DATATABLE = 'coins';

// CONCATENATED MODULE: ./coins/api/get-id.api.ts
...
// CONCATENATED MODULE: ./coins/api/coin.model.ts


const CoinModel = new core_model["a" /* Model */]({
...
// CONCATENATED MODULE: ./coins/api/update.api.ts
...
update_api___decorate([
    ...
    Object(service["a" /* ACL */])(role["a" /* Role */].Ads, role["a" /* Role */].Administrator, role["a" /* Role */].Su),
...
// CONCATENATED MODULE: ./coins/api/index.ts




// CONCATENATED MODULE: ./coins/main.ts




process.env.TZ = 'UTC';
new service["i" /* Service */](new db["c" /* DBMiddleware */](), new session["a" /* CustomSessionMiddleware */](), new get_list_api_GetListAPI(), new get_id_api_GetByIdAPI(), new update_api_UpdateAPI());
