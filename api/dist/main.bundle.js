...
var external__crypto_ = __webpack_require__(14);
...
var external__http_ = __webpack_require__(7);
...
var external__string_decoder_ = __webpack_require__(11);
var external__string_decoder__default = /*#__PURE__*/__webpack_require__.n(external__string_decoder_);

// EXTERNAL MODULE: external "querystring"
var external__querystring_ = __webpack_require__(29);
...
var external__path_ = __webpack_require__(12);
...
var external__util_ = __webpack_require__(5);
...
// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/core/timestamp/index.ts + 1 modules
var timestamp = __webpack_require__(4);
...
class ads_Ads {
    constructor(value = {}) {
        ...
        this.startDate = new timestamp["a" /* Timestamp */](value.startDate);
        this.endDate = new timestamp["a" /* Timestamp */](value.endDate);
...
class historical_Historical {
    constructor(value = {}) {
        ...
        this.ts = new timestamp["a" /* Timestamp */](value.ts);
...
class coin_Coin {
    ...
    update(value = {}) {
        ...
        this._ts = new timestamp["a" /* Timestamp */](value.ts);
        this.updatePrice(value.price);
...
class publication_Publication {
    constructor(value = {}) {
        ...
        this.sections = uuid["a" /* UUID */].getArray(value.sections);
        this.currencies = Array.isArray(value.currencies) ? value.currencies
            .map((item) => String(item).trim().toLowerCase())
            .filter((item) => !!item)
            : new Array();
        this.exchanges = uuid["a" /* UUID */].getArray(value.exchanges);
        this.ico = uuid["a" /* UUID */].getArray(value.ico);
        this.markets = uuid["a" /* UUID */].getArray(value.markets);
        ...
        this.image = Math.max(~~value.image, 0) || null;
        this.ogImage = Math.max(~~value.ogImage, 0) || null;
        this.authors = uuid["a" /* UUID */].getArray(value.authors);
        ...
        this.rating = new Rating(value.rating);
        this.branding = {};
        this.lastModified = new timestamp["a" /* Timestamp */](value.lastModified);
        if (!this.url)
...
class user_User {
    constructor(value = {}) {
        ...
        this.oauth = {};
        this.image = Math.max(~~value.image, 0) || null;
        this.statuses = uuid["a" /* UUID */].getArray(value.statuses);
        this.rating = new Rating(value.rating);
        this.bjr = Math.min(Math.max(~~value.bjr, 0), 5);
        this.card = {};
    }
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "b", function() { return coin_Coin; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "h", function() { return Price; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "e", function() { return historical_Historical; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "c", function() { return currency_Currency; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "d", function() { return exchange_Exchange; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "f", function() { return ico_ICO; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "g", function() { return market_Market; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "i", function() { return publication_Publication; });
/* unused concated harmony import null */
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, false, function() { return Rating; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "k", function() { return section_Section; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "l", function() { return status_Status; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "j", function() { return RoleEnum; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "m", function() { return user_User; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "n", function() { return Video; });
/* unused concated harmony import null */
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, false, function() { return event_Event; });
...
// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/common/pg-pool/index.ts + 2 modules
var pg_pool = __webpack_require__(15);
...
// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/common/models/index.ts + 34 modules
...
class session_Session {
    ...
    set user(value) {
        if (!value)
            ...
            let user = value instanceof models["m" /* User */] ? value : new models["m" /* User */](value);
    ...
    get valid() {
        return this.id.length > 0
            && this._user instanceof models["m" /* User */]
            && this._user.valid;
    }
    valueOf() {
        return {
...
class session_middleware_SessionMiddleware extends service["d" /* Middleware */] {
    async main(ctx, next) {
        ...
        if (result.rowCount === 1)
            session.user = new models["m" /* User */](result.rows[0]);
        ctx.session = session;
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "a", function() { return Timestamp; });
...
var pgTypes = __webpack_require__(9)
...
var textParsers = __webpack_require__(31);
var binaryParsers = __webpack_require__(36);
var arrayParser = __webpack_require__(18);
...
const defaults = __webpack_require__(8)
...
// CONCATENATED MODULE: /Users/wisdman/Projects/bitjournal/common/pg-pool/environments.ts
...
// CONCATENATED MODULE: /Users/wisdman/Projects/bitjournal/common/pg-pool/pg-pool.ts


const pgPool = new lib["Pool"](POSTGRES_POOL_CONFIG);

// CONCATENATED MODULE: /Users/wisdman/Projects/bitjournal/common/pg-pool/index.ts
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "a", function() { return pgPool; });
...
var PG = function (clientConstructor) {
  ...
  this.types = __webpack_require__(9)
}

if (typeof process.env.NODE_PG_FORCE_NATIVE !== 'undefined') {
  module.exports = new PG(__webpack_require__(24))
} else {
  ...
  module.exports.__defineGetter__('native', function () {
    ...
    var native = null
    try {
      native = new PG(__webpack_require__(24))
    } catch (err) {
...
var dns = __webpack_require__(42)

var defaults = __webpack_require__(8)

var parse = __webpack_require__(43).parse // parses a connection string
...
var Writer = __webpack_require__(48)
var Reader = __webpack_require__(49)
...
var promiseFromCallback = __webpack_require__(25);
var ReadStream = __webpack_require__(27);
var WriteStream = __webpack_require__(28);
...
var pgPass = __webpack_require__(37)
var TypeOverrides = __webpack_require__(19)

var ConnectionParameters = __webpack_require__(20)
...
var array = __webpack_require__(17)
var arrayParser = __webpack_require__(18);
var parseDate = __webpack_require__(32);
var parseInterval = __webpack_require__(33);
var parseByteA = __webpack_require__(35);
...
var through = __webpack_require__(41)
...
class Pool extends EventEmitter {
  constructor (options, Client) {
    ...
    this.Client = this.options.Client || Client || __webpack_require__(16).Client
...
var TypeOverrides = __webpack_require__(19)
var semver = __webpack_require__(53)
...
var NativeQuery = __webpack_require__(55)
...
// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/common/middleware/index.ts + 6 modules
...
__decorate([
    ...
    Object(middleware["a" /* ACL */])([
        models["j" /* RoleEnum */].Administrator,
        models["j" /* RoleEnum */].Su,
    ]),
...
class auth_api_AuthAPI extends service["g" /* RouteMiddleware */] {
    ...
    async login(ctx, next) {
        ...
        ctx.session.user = new models["m" /* User */](result.rows[0]);
        if (!ctx.session.user) {
            ctx.set(403);
            return;
        }
...
class currencies_api_CurrenciesAPI extends service["g" /* RouteMiddleware */] {
    async getAll(ctx, next) {
        const db = ctx.db;
        const query = new query_Query(currencies_api_DATATABLE).select(models["c" /* Currency */].MainFields);
        ctx.debug(`=== SQL Query [GET /${currencies_api_ROUTE_BASE}] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${currencies_api_ROUTE_BASE}] ===\n%s`, result.rows);
        const resultItems = result.rows.map(item => new models["c" /* Currency */](item));
        ctx.set(resultItems);
    }
    async getAllEnabled(ctx, next) {
        const db = ctx.db;
    ...
    async getOne(ctx, next) {
        ...
        const resultItem = new models["c" /* Currency */](result.rows[0]);
        ctx.set(resultItem);
    }
    async getOneEnabled(ctx, next) {
        const route = ctx.route;
    ...
    async add(ctx, next) {
        const db = ctx.db;
        const data = await ctx.request.json();
        const item = new models["c" /* Currency */](data);
...
class exchanges_api_ExchangesAPI extends service["g" /* RouteMiddleware */] {
    async getAll(ctx, next) {
        const db = ctx.db;
        const query = new query_Query(exchanges_api_DATATABLE).select(models["d" /* Exchange */].MainFields);
        ctx.debug(`=== SQL Query [GET /${exchanges_api_ROUTE_BASE}] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${exchanges_api_ROUTE_BASE}] ===\n%s`, result.rows);
        const resultItems = result.rows.map(item => new models["d" /* Exchange */](item));
        ctx.set(resultItems);
    }
    async getAllEnabled(ctx, next) {
        const db = ctx.db;
    ...
    async getOne(ctx, next) {
        ...
        const resultItem = new models["d" /* Exchange */](result.rows[0]);
        ctx.set(resultItem);
    }
    async getOneEnabled(ctx, next) {
        const route = ctx.route;
    ...
    async add(ctx, next) {
        const db = ctx.db;
        const data = await ctx.request.json();
        const item = new models["d" /* Exchange */](data);
...
class ico_api_ICOAPI extends service["g" /* RouteMiddleware */] {
    async getAll(ctx, next) {
        const db = ctx.db;
        const query = new query_Query(ico_api_DATATABLE).select(models["f" /* ICO */].MainFields);
        ctx.debug(`=== SQL Query [GET /${ico_api_ROUTE_BASE}] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${ico_api_ROUTE_BASE}] ===\n%s`, result.rows);
        const resultItems = result.rows.map(item => new models["f" /* ICO */](item));
        ctx.set(resultItems);
    }
    async getAllEnabled(ctx, next) {
        const db = ctx.db;
    ...
    async getOne(ctx, next) {
        ...
        const resultItem = new models["f" /* ICO */](result.rows[0]);
        ctx.set(resultItem);
    }
    async getOneEnabled(ctx, next) {
        const route = ctx.route;
    ...
    async add(ctx, next) {
        const db = ctx.db;
        const data = await ctx.request.json();
        const item = new models["f" /* ICO */](data);
...
class markets_api_MarketsAPI extends service["g" /* RouteMiddleware */] {
    async getAll(ctx, next) {
        const db = ctx.db;
        const query = new query_Query(markets_api_DATATABLE).select(models["g" /* Market */].MainFields);
        ctx.debug(`=== SQL Query [GET /${markets_api_ROUTE_BASE}] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${markets_api_ROUTE_BASE}] ===\n%s`, result.rows);
        const resultItems = result.rows.map(item => new models["g" /* Market */](item));
        ctx.set(resultItems);
    }
    async getAllEnabled(ctx, next) {
        const db = ctx.db;
    ...
    async getOne(ctx, next) {
        ...
        const resultItem = new models["g" /* Market */](result.rows[0]);
        ctx.set(resultItem);
    }
    async getOneEnabled(ctx, next) {
        const route = ctx.route;
    ...
    async add(ctx, next) {
        const db = ctx.db;
        const data = await ctx.request.json();
        const item = new models["g" /* Market */](data);
...
class publications_api_PublicationsAPI extends service["g" /* RouteMiddleware */] {
    async getAll(ctx, next) {
        const db = ctx.db;
        const query = new query_Query(publications_api_DATATABLE).select(models["i" /* Publication */].MainFields)
            .order({ 'ts': 'DESC' });
        ctx.debug(`=== SQL Query [GET /${publications_api_ROUTE_BASE}] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${publications_api_ROUTE_BASE}] ===\n%s`, result.rows);
        const resultItems = result.rows.map(item => new models["i" /* Publication */](item));
        ctx.set(resultItems);
    }
    async getByWeigh(ctx, next) {
        const route = ctx.route;
        const db = ctx.db;
        ...
        let query = new query_Query(publications_api_DATATABLE).select(models["i" /* Publication */].MainFields)
            .where(`enable AND ts <= timezone('UTC', now()) AND weight IN (${weightList.join(',')})`)
            .order({ 'ts': 'DESC' });
        const limit = Math.max(parseInt(new Array().concat(route.query['limit']).join('')) || 0, 0);
        if (limit > 0)
            query = query.limit(limit);
        ctx.debug(`=== SQL Query [GET /${publications_api_ROUTE_BASE}?weight] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${publications_api_ROUTE_BASE}?weight] ===\n%s`, result.rows);
        const resultItems = result.rows.map(item => new models["i" /* Publication */](item));
        ctx.set(resultItems);
    }
    async getAllEnabled(ctx, next) {
    ...
    async getOne(ctx, next) {
        ...
        const resultItem = new models["i" /* Publication */](result.rows[0]);
        ctx.set(resultItem);
    }
    async getOneEnabled(ctx, next) {
        const route = ctx.route;
    ...
    async getOneByUrl(ctx, next) {
        ...
        ctx.debug(`=== SQL Query [GET /${publications_api_ROUTE_BASE}/:date/:url] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${publications_api_ROUTE_BASE}/:date/:url] ===\n%s`, result.rows);
        if (result.rowCount !== 1) {
            ctx.set(404);
            return;
        }
    ...
    async add(ctx, next) {
        const db = ctx.db;
        const data = await ctx.request.json();
        const item = new models["i" /* Publication */](data);
...
publications_api___decorate([
    Object(service["c" /* Get */])(`/${publications_api_ROUTE_BASE}`, 'weight'),
    publications_api___metadata("design:type", Function),
    publications_api___metadata("design:paramtypes", [service["a" /* Context */], Function]),
    publications_api___metadata("design:returntype", Promise)
], publications_api_PublicationsAPI.prototype, "getByWeigh", null);
publications_api___decorate([
    Object(service["c" /* Get */])(`/${publications_api_ROUTE_BASE}`),
    publications_api___metadata("design:type", Function),
    publications_api___metadata("design:paramtypes", [service["a" /* Context */], Function]),
...
publications_api___decorate([
    Object(service["c" /* Get */])(`/${publications_api_ROUTE_BASE}/:date/:url`),
    publications_api___metadata("design:type", Function),
    publications_api___metadata("design:paramtypes", [service["a" /* Context */], Function]),
    publications_api___metadata("design:returntype", Promise)
], publications_api_PublicationsAPI.prototype, "getOneByUrl", null);
publications_api___decorate([
...
class sections_api_SectionsAPI extends service["g" /* RouteMiddleware */] {
    async getAll(ctx, next) {
        const db = ctx.db;
        const query = new query_Query(sections_api_DATATABLE).select(models["k" /* Section */].MainFields);
        ctx.debug(`=== SQL Query [GET /${sections_api_ROUTE_BASE}] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${sections_api_ROUTE_BASE}] ===\n%s`, result.rows);
        const resultItems = result.rows.map(item => new models["k" /* Section */](item));
        ctx.set(resultItems);
    }
    async getAllEnabled(ctx, next) {
        const db = ctx.db;
    ...
    async getOne(ctx, next) {
        ...
        const resultItem = new models["k" /* Section */](result.rows[0]);
        ctx.set(resultItem);
    }
    async getOneEnabled(ctx, next) {
        const route = ctx.route;
    ...
    async add(ctx, next) {
        const db = ctx.db;
        const data = await ctx.request.json();
        const item = new models["k" /* Section */](data);
...
class statuses_api_StatusesAPI extends service["g" /* RouteMiddleware */] {
    async getAll(ctx, next) {
        const db = ctx.db;
        const query = new query_Query(statuses_api_DATATABLE).select(models["l" /* Status */].MainFields)
            .order('title');
        ctx.debug(`=== SQL Query [GET /${statuses_api_ROUTE_BASE}] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${statuses_api_ROUTE_BASE}] ===\n%s`, result.rows);
        const resultItems = result.rows.map(item => new models["l" /* Status */](item));
        ctx.set(resultItems);
    }
    async getAllEnabled(ctx, next) {
        const db = ctx.db;
    ...
    async getOne(ctx, next) {
        ...
        const resultItem = new models["l" /* Status */](result.rows[0]);
        ctx.set(resultItem);
    }
    async getOneEnabled(ctx, next) {
        const route = ctx.route;
    ...
    async add(ctx, next) {
        const db = ctx.db;
        const data = await ctx.request.json();
        const item = new models["l" /* Status */](data);
...
var external__url_ = __webpack_require__(21);
...
var external__https_ = __webpack_require__(59);
...
// CONCATENATED MODULE: ./api/ticker/sources/coinmarketcap/coinmarketcap.ts



const TICKER_URL = 'https://api.coinmarketcap.com/v1/ticker/?limit=0';
const HISTORICAL_URL = (id) => `https://graphs.coinmarketcap.com/currencies/${id}/`;
const TICKER_UPDATE_LIMIT = 60000;
const HISTORICAL_UPDATE_LIMIT = 3600000;
class coinmarketcap_CoinMarketCapSource {
    constructor() {
        this._http = new http_HTTP();
        this.coins = new Array();
        this._ids = {};
        this._tickerLastUpdateMoment = 0;
    }
    updateItem(newItem) {
    ...
    async updateTicker(symbols) {
        ...
        const data = await this._http.json(TICKER_URL);
        return data.filter(item => symbols.includes(item.symbol))
            ...
            return {
                ...
                price: new models["h" /* Price */]({
                    btc: item['price_btc'],
                    usd: item['price_usd'],
                }),
                ts: timestamp["a" /* Timestamp */].fromUnux(item['last_updated'])
            };
        })
            .map(item => new models["b" /* Coin */](item))
            .map(item => this.updateItem(item));
    }
    historicalDataItemToHistorical(items, type) {
        return items.map(item => new models["e" /* Historical */]({
            ts: new timestamp["a" /* Timestamp */](item[0]),
            price: new models["h" /* Price */]({ [type]: item[1] })
        }));
    }
    async updateHistorical(coin) {
        ...
        const data = await this._http.json(url);
...
// CONCATENATED MODULE: ./api/ticker/sources/coinmarketcap/index.ts


// CONCATENATED MODULE: ./api/ticker/sources/index.ts


// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/common/pg-pool/index.ts + 2 modules
var pg_pool = __webpack_require__(15);

// CONCATENATED MODULE: ./api/ticker/currencies.ts


const currencies_DATATABLE = 'currencies';
async function getSymbols() {
    const db = await pg_pool["a" /* pgPool */].connect();
    const query = new query_Query(currencies_DATATABLE).select(['symbol'])
        .where('enable');
    const result = await db.query(query.valueOf());
    return result.rows.map(item => String(item.symbol));
}

// CONCATENATED MODULE: ./api/ticker/ticker.api.ts
var ticker_api___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var ticker_api___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
const ticker_api_ROUTE_BASE = 'ticker';
class ticker_api_TickerAPI extends service["g" /* RouteMiddleware */] {
    constructor({ updateInterval = 60000, } = {}) {
        ...
        this._sources.push(new coinmarketcap_CoinMarketCapSource());
        this.updateLoop();
    }
    updateItem(value) {
        const newItem = new models["b" /* Coin */](value);
    ...
    async tickers(ctx, next) {
        ctx.set(this._coins);
    }
    async ticker(ctx, next) {
        const route = ctx.route;
...
ticker_api___decorate([
    Object(service["c" /* Get */])(`/${ticker_api_ROUTE_BASE}`),
    ticker_api___metadata("design:type", Function),
    ticker_api___metadata("design:paramtypes", [service["a" /* Context */], Function]),
    ticker_api___metadata("design:returntype", Promise)
], ticker_api_TickerAPI.prototype, "tickers", null);
ticker_api___decorate([
    Object(service["c" /* Get */])(`/${ticker_api_ROUTE_BASE}/:symbol`),
    ticker_api___metadata("design:type", Function),
    ticker_api___metadata("design:paramtypes", [service["a" /* Context */], Function]),
    ticker_api___metadata("design:returntype", Promise)
], ticker_api_TickerAPI.prototype, "ticker", null);
ticker_api___decorate([
    Object(service["c" /* Get */])(`/${ticker_api_ROUTE_BASE}/:symbol/historical`),
    ticker_api___metadata("design:type", Function),
    ticker_api___metadata("design:paramtypes", [service["a" /* Context */], Function]),
    ticker_api___metadata("design:returntype", Promise)
], ticker_api_TickerAPI.prototype, "historical", null);

// CONCATENATED MODULE: ./api/ticker/index.ts
...
class users_api_UsersAPI extends service["g" /* RouteMiddleware */] {
    async getAllForSU(ctx, next) {
        const db = ctx.db;
        const query = new query_Query(users_api_DATATABLE).select(models["m" /* User */].MainFields);
        ctx.debug(`=== SQL Query [GET /${users_api_ROUTE_BASE}] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${users_api_ROUTE_BASE}] ===\n%s`, result.rows);
        const resultItems = result.rows.map(item => new models["m" /* User */](item));
        ctx.set(resultItems);
    }
    async getAll(ctx, next) {
        const db = ctx.db;
        const query = new query_Query(users_api_DATATABLE).select(models["m" /* User */].AnonymousFields)
            .where('enabled');
        ctx.debug(`=== SQL Query [GET /${users_api_ROUTE_BASE}] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${users_api_ROUTE_BASE}] ===\n%s`, result.rows);
    ...
    async getMe(ctx, next) {
        ...
        const resultItem = new models["m" /* User */](result.rows[0]);
        ctx.set(resultItem);
    }
    async getOneForSU(ctx, next) {
        const route = ctx.route;
        const db = ctx.db;
        let id;
        try {
    ...
    async add(ctx, next) {
        const db = ctx.db;
        const data = await ctx.request.json();
        const item = new models["m" /* User */](data);
...
], users_api_UsersAPI.prototype, "getAllForSU", null);
users_api___decorate([
    Object(service["c" /* Get */])(`/${users_api_ROUTE_BASE}`),
    users_api___metadata("design:type", Function),
    users_api___metadata("design:paramtypes", [service["a" /* Context */], Function]),
...
users_api___decorate([
    ...
    users_api___metadata("design:paramtypes", [service["a" /* Context */], Function]),
    users_api___metadata("design:returntype", Promise)
], users_api_UsersAPI.prototype, "getOneForSU", null);
users_api___decorate([
    Object(service["c" /* Get */])(`/${users_api_ROUTE_BASE}/:id`),
    users_api___metadata("design:type", Function),
    users_api___metadata("design:paramtypes", [service["a" /* Context */], Function]),
...
class video_api_VideoAPI extends service["g" /* RouteMiddleware */] {
    async getAll(ctx, next) {
        const db = ctx.db;
        const query = new query_Query(video_api_DATATABLE).select(models["n" /* Video */].MainFields);
        ctx.debug(`=== SQL Query [GET /${video_api_ROUTE_BASE}] ===\n%s`, query);
        const result = await db.query(query.valueOf());
        ctx.debug(`=== SQL Result [GET /${video_api_ROUTE_BASE}] ===\n%s`, result.rows);
        const resultItems = result.rows.map(item => new models["n" /* Video */](item));
        ctx.set(resultItems);
    }
    async getAllEnabled(ctx, next) {
        const db = ctx.db;
    ...
    async getOne(ctx, next) {
        ...
        const resultItem = new models["n" /* Video */](result.rows[0]);
        ctx.set(resultItem);
    }
    async getOneEnabled(ctx, next) {
        const route = ctx.route;
    ...
    async add(ctx, next) {
        const db = ctx.db;
        const data = await ctx.request.json();
        const item = new models["n" /* Video */](data);
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "h", function() { return raw_api_RawAPI; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "i", function() { return sections_api_SectionsAPI; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "j", function() { return statuses_api_StatusesAPI; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "k", function() { return ticker_api_TickerAPI; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "l", function() { return users_api_UsersAPI; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "m", function() { return video_api_VideoAPI; });
 ...
 * @type {function}
 */
exports.LargeObject = __webpack_require__(26);
 ...
 * @type {function}
 */
exports.ReadStream = __webpack_require__(27);
 ...
 * @type {function}
 */
exports.WriteStream = __webpack_require__(28);
...
var promiseFromCallback = __webpack_require__(25);
var LargeObject = __webpack_require__(26);
...
process.env.TZ = 'UTC';
new __WEBPACK_IMPORTED_MODULE_0__core_service__["h" /* Service */](new __WEBPACK_IMPORTED_MODULE_1__common_middleware__["b" /* PgDBMiddleware */](), new __WEBPACK_IMPORTED_MODULE_1__common_middleware__["c" /* SessionMiddleware */](), new __WEBPACK_IMPORTED_MODULE_2__api__["a" /* AdsAPI */](), new __WEBPACK_IMPORTED_MODULE_2__api__["b" /* AuthAPI */](), new __WEBPACK_IMPORTED_MODULE_2__api__["c" /* CurrenciesAPI */](), new __WEBPACK_IMPORTED_MODULE_2__api__["d" /* ExchangesAPI */](), new __WEBPACK_IMPORTED_MODULE_2__api__["e" /* ICOAPI */](), new __WEBPACK_IMPORTED_MODULE_2__api__["f" /* MarketsAPI */](), new __WEBPACK_IMPORTED_MODULE_2__api__["g" /* PublicationsAPI */](), new __WEBPACK_IMPORTED_MODULE_2__api__["i" /* SectionsAPI */](), new __WEBPACK_IMPORTED_MODULE_2__api__["j" /* StatusesAPI */](), new __WEBPACK_IMPORTED_MODULE_2__api__["l" /* UsersAPI */](), new __WEBPACK_IMPORTED_MODULE_2__api__["m" /* VideoAPI */]());
