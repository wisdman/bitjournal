...
var timestamp = __webpack_require__(5);
...
// EXTERNAL MODULE: /Users/wisdman/Projects/bitjournal/common/models/index.ts + 32 modules
...
class ticker_api_TickerAPI extends service["g" /* RouteMiddleware */] {
    constructor({ updateSymbolsInterval = 600000, updateTickerInterval = 600000, } = {}) {
        super();
        this._symbols = new Array();
        this._coins = new Array();
        this._sources = new Array();
        this._updateSymbolsInterval = 30000;
        this._updateTickerInterval = 30000;
